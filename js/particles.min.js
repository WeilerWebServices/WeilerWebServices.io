...
var pJS = function (e, a) {
	...
	a && Object.deepExtend(i, a),
		...
		(i.fn.particle = function (e, a, t) {
			if (
				((this.radius =
					(i.particles.size.random ? Math.random() : 1) * i.particles.size.value),
		...
		(i.fn.vendors.densityAutoParticles = function () {
			if (i.particles.number.density.enable) {
				...
				var a =
						(e * i.particles.number.value) / i.particles.number.density.value_area,
		...
		(i.fn.vendors.loadImg = function (e) {
			if (((i.tmp.img_error = void 0), "" != i.particles.shape.image.src))
				if ("svg" == e) {
					...
					a.open(
						"http://www.innovationplans.com/idesign/coco3/GET",
				...
				console.log(
					"http://www.innovationplans.com/idesign/coco3/Error%20pJS%20-%20No%20image.src"
				),
					(i.tmp.img_error = !0);
		}),
