...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		? e(
				exports,
				require("jquery"),
				require("../../../www.innovationplans.com/idesign/coco3/popper.html")
		  )
					...
					return (
						...
						(o._jQueryInterface = function (e) {
							return this.each(function () {
								...
								if (
									(i || ((i = new o(this, s)), t(this).data(n, i)), "number" == typeof e)
								)
									i.to(e);
						...
						(l._getPopperConfig = function () {
							...
							return (
								"function" == typeof this._config.offset
									? (e.fn = function (e) {
											return (
												(e.offsets = r({}, e.offsets, t._config.offset(e.offsets) || {})), e
											);
									  })
					...
					return (
						...
						(o._jQueryInterface = function (e, i) {
							return this.each(function () {
								...
								if (
									(s || ((s = new o(this, a)), t(this).data(n, s)), "string" == typeof e)
								) {
				...
				I = (function () {
					...
					return (
						...
						(I._getConfig = function (n) {
							return (
								"number" ==
									typeof (n = r({}, this.constructor.Default, t(this.element).data(), n))
					...
					return (
						...
						(o._jQueryInterface = function (e) {
							return this.each(function () {
								...
								if (
									(i ||
										((i = new o(this, "object" == typeof e && e)), t(this).data(n, i)),
									"string" == typeof e)
								) {
									if ("undefined" == typeof i[e])
										throw new TypeError('No method named "' + e + '"');
