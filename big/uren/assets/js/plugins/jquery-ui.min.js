...
(function (t) {
					...
					f(i, function (e, i) {
						(t.cssHooks[i] = {
							...
							(t.fx.step[i] = function (e) {
								e.colorInit ||
									((e.start = h(e.elem, i)), (e.end = h(e.end)), (e.colorInit = !0)),
		...
		t.effects.define("bounce", function (e, i) {
			...
			for (
				...
				(s = {}),
					...
					(u = l ? 2 * u : u / 2);
			l &&
				((s = { opacity: 0 }), (s[m] = (_ ? "-=" : "+=") + u), a.animate(s, f, g)),
				a.queue(i),
			...
			(t.position = {
				...
				getScrollInfo: function (e) {
					var i = e.isWindow || e.isDocument ? "" : e.element.css("overflow-x"),
						...
						n =
							"scroll" === i || ("auto" === i && e.width < e.element[0].scrollWidth),
						o =
	...
	(t.cleanData = (function (e) {
		...
		t.widget("ui.autocomplete", {
			...
			_isEventTargetInWidget: function (e) {
				...
				return (
					e.target === this.element[0] || e.target === i || t.contains(i, e.target)
				);
			},
	...
	t.widget("ui.controlgroup", {
		...
		_spinnerOptions: function (t) {
			...
			return (
				(e.classes["ui-spinner-up"] = ""), (e.classes["ui-spinner-down"] = ""), e
			);
		},
	...
	t.extend(s.prototype, {
		...
		_setDateDatepicker: function (t, e) {
			...
			i &&
				(this._setDate(i, e), this._updateDatepicker(i), this._updateAlternate(i));
		},
		_getDateDatepicker: function (t, e) {
			var i = this._getInst(t);
			return (
				i && !i.inline && this._setDateFromField(i, e), i ? this._getDate(i) : null
			);
		},
		...
		_updateDatepicker: function (e) {
			...
			r.length > 0 && o.apply(r.get(0)),
				e.dpDiv
					...
					.width(""),
				n > 1 &&
					e.dpDiv.addClass("ui-datepicker-multi-" + n).css("width", a * n + "em"),
		...
		_checkOffset: function (e, i, s) {
			var n = e.dpDiv.outerWidth(),
				...
				l =
					document.documentElement.clientWidth + (s ? 0 : t(document).scrollLeft()),
				h =
					document.documentElement.clientHeight + (s ? 0 : t(document).scrollTop());
			return (
				(i.left -= this._get(e, "isRTL") ? n - a : 0),
				(i.left -=
					s && i.left === e.input.offset().left ? t(document).scrollLeft() : 0),
				(i.top -=
					s && i.top === e.input.offset().top + r ? t(document).scrollTop() : 0),
				(i.left -= Math.min(
					i.left,
							...
							(W = m ? m.apply(t.input ? t.input[0] : null, [z]) : [!0, ""]),
								...
								(E +=
									...
									(F && !_
										...
										: " " +
										  W[1] +
										  (z.getTime() === G.getTime() ? " " + this._currentClass : "") +
										  (z.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) +
									"'" +
									((F && !_) || !W[2]
										? ""
										: " title='" + W[2].replace(/'/g, "&#39;") + "'") +
		...
		_adjustInstDate: function (t, e, i) {
			var s = t.selectedYear + ("Y" === i ? e : 0),
				...
				o =
					Math.min(t.selectedDay, this._getDaysInMonth(s, n)) + ("D" === i ? e : 0),
			...
			resize: function (e) {
				...
				d[0] !== document && /static/.test(d.css("position")) && (u = l),
					h.left < (a._helper ? l.left : 0) &&
						((a.size.width =
							a.size.width +
							(a._helper ? a.position.left - l.left : a.position.left - u.left)),
		...
		t.widget("ui.dialog", {
			...
			_size: function () {
				...
				this.element
					...
					(i =
						"number" == typeof s.maxHeight ? Math.max(0, s.maxHeight - t) : "none"),
					"auto" === s.height
					...
					return (
						...
						this.selectees.each(function () {
							...
							i &&
								...
								"touch" === n.tolerance
									? (h = !(c.left > r || o > c.right || c.top > l || a > c.bottom))
									: "fit" === n.tolerance &&
									  (h = c.left > o && r > c.right && c.top > a && l > c.bottom),
								h
									? (i.selected &&
		...
		t.widget("ui.selectmenu", [
			t.ui.formResetMixin,
			{
				...
				_renderButtonItem: function (e) {
					var i = t("<span>");
					return (
						this._setText(i, e.label), this._addClass(i, "ui-selectmenu-text"), i
					);
				},
				_renderMenu: function (e, i) {
					var s = this,
