...
!(function (a, b) {
			...
			queue: function (a, b, c) {
				...
				return a
					? ((b = (b || "fx") + "queue"),
					  (d = n._data(a, b)),
					  c &&
							(!d || n.isArray(c) ? (d = n._data(a, b, n.makeArray(c))) : d.push(c)),
					  d || [])
					: void 0;
			},
	...
	function fb(a, b, c) {
		...
		if (0 >= e || null == e) {
			if (
				((e = Sa(a, b, f)), (0 > e || null == e) && (e = a.style[b]), Oa.test(e))
			)
				return e;
	...
	n.fn.extend({
		addClass: function (a) {
			...
			if ("string" == typeof a && a) {
				...
				while ((c = this[i++]))
					if (
						((e = Cb(c)), (d = 1 === c.nodeType && (" " + e + " ").replace(Bb, " ")))
					) {
						g = 0;
			...
			void 0 !== a.ActiveXObject
				? function () {
						return this.isLocal
							...
							: d.documentMode > 8
							? hc()
							: (/^(get|post|head|put|delete|options)$/i.test(this.type) && hc()) ||
							  ic();
				  }
				: hc);
	var ec = 0,
